export class Constants {
    ...
    static KEY_REVIEWED_DOCTORS = "dw_reviews_doctors"
    static KEY_SEARCH_HISTORY = "dw_searchhistory";
    static KEY_IS_DEMO_MODE = 'dw_is_demo_mode'
    static KEY_PRESCRIPTION_URL = "prescription_url";
    static KEY_SAVED_BANNER = 'grohopw_saved_banner';
    ...
    static REF_INDICATION = "fire_app/indication";
    ...
    static SCOPE_HOSPITAL_CATEGORIE = "category";
